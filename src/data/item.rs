...
pub enum Item {
    ...
    SootheBell, CleanseTag, ChoiceBand, ChoiceScarf, ChoiceSpec, BlackSludge, LifeOrb, RockyHelmet, StickyBarb,
    GripClaw, LightClay, TerrainExtender, AssaultVest, BerserkGene, FlameOrb, IronBall, LaggingTail, MachoBrace,
    RingTarget, ToxicOrb, UtilityUmbrella, Leftovers, AbsorbBulb, CellBattery, EjectButton, LuminousMoss,
